...
mathematics.  That does not bother them in the slightest.
...
Item~5 I really agree with.  What we want is a \emph{dao} of mathematics.
...
They note that some other authors they cite (Linnebo and Pettigrew, 2011,
but we do not cite) assert that category theory is not foundational because
...
\item the univalence axiom can be considered to just be Leibniz's principle
    of the identity of indiscernibles (or its inverse, if you consider that
...
Oof.  \citet{ladyman-presnell-foundations} do not mention the univalence
