...
When $G / \ker(f)$ is not isomorphic to $G$ or the trivial group,
we have factored $G$.
...
The notes for Chapters~6 and~11 {in} \citet{hott-book} say the theories
...
But this is wrong (\citealp{bauer-hott} and \citet[Remark~6.11.2]{hott-book}).
